...
#ifndef GAMEAIBYEXAMPLE_EXERCISE2_PATH_H
#define GAMEAIBYEXAMPLE_EXERCISE2_PATH_H
...
//    Vector2D    CurrentWaypoint()const{assert(curWaypoint != nullptr); return *curWaypoint;}
...
#endif //GAMEAIBYEXAMPLE_EXERCISE2_PATH_H
